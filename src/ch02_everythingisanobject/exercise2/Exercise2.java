package ch02_everythingisanobject.exercise2;
...
// list. Compile the program with javac and run it using java. If you are using a different development environment
